...
class Index extends React.Component {
  ...
  render() {
    ...
    let postsArray = keys.map((key) => (
      {id: key, votes: posts[key].votes, comments: posts[key].comments, num_comments: (posts[key].num_comments===null ? 0 : posts[key].num_comments), total_points: (posts[key].total_points===null ? 0 : posts[key].total_points), title: posts[key].title, image_url: posts[key].image_url}));
